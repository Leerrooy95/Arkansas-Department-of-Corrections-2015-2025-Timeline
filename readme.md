...
|---------------------------------|--------------------------------------------------------------------------------------|-----------------------------------------------------|---------------------------------|
| March population surge          | Mean March ADC population exceeds non-March months by 1,126 inmates (2015–2025)     | 10,000 permutation test of monthly means            | p < 0.0001 (highly significant) |
...
## License & Reuse
All data are released under CC0 1.0 (public domain).  
